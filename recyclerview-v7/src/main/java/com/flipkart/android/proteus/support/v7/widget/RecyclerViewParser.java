...
public class RecyclerViewParser<V extends RecyclerView> extends ViewTypeParser<V> {
    ...
    protected void addAttributeProcessors() {
        ...
        addAttributeProcessor(ATTRIBUTE_ADAPTER, new AttributeProcessor<V>() {
                ...
                if (value.isObject()) {
                    ...
                    if (type != null) {
                        ProteusRecyclerViewAdapter adapter =
                            adapterFactory.create(type, (ProteusRecyclerView) view,
                                value.getAsObject());
            ...
            public void handleResource(V view, Resource resource) {
                throw new IllegalArgumentException(
                    "Recycler View 'adapter' expects only object " + "values");
            }
        ...
        addAttributeProcessor(ATTRIBUTE_LAYOUT_MANAGER, new AttributeProcessor<V>() {
                ...
                if (value.isObject()) {
                    ...
                    if (type != null) {
                        RecyclerView.LayoutManager layoutManager =
                            layoutManagerFactory.create(type, (ProteusRecyclerView) view,
                                value.getAsObject());
            ...
            public void handleResource(V view, Resource resource) {
                throw new IllegalArgumentException(
                    "Recycler View 'layout_manager' expects only " + "object values");
            }
