...
import static com.flipkart.android.proteus.view.custom.ExpandableLayout.State.COLLAPSED;
import static com.flipkart.android.proteus.view.custom.ExpandableLayout.State.COLLAPSING;
import static com.flipkart.android.proteus.view.custom.ExpandableLayout.State.EXPANDED;
import static com.flipkart.android.proteus.view.custom.ExpandableLayout.State.EXPANDING;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (parallax > 0) {
            ...
            for (int i = 0; i < getChildCount(); i++) {
                View child = getChildAt(i);if (orientation == HORIZONTAL) {
                    int direction = -1;
