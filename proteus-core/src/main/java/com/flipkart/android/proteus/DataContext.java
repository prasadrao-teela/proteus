...
public class DataContext {
     ...
     *
     * @param context The proteus android context to resolve {@link FunctionBinding} to evaluate
     * the scope.
     * @param data The data to be used by the data context.
     * @param dataIndex The data index to used by the data context.
     ...
     * @return A new data context with scope evaluated.
     */
    public DataContext createChild(@NonNull ProteusContext context,
        @NonNull Map<String, Value> scope, int dataIndex) {
